    ...
    def sample_actions(
        ...
        *,
        ...
        def step(carry):
            ...
            pre_vel = suffix_out[:, -self.action_horizon :]
            acc = acc.at[:, flow_step].set(pre_vel)
            v_t = self.action_out_proj(pre_vel)

            return x_t + dt * v_t, time + dt, acc, flow_step + 1
