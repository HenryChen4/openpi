...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_fast_libero_domain_randomization",
        model=pi0_fast.Pi0FASTConfig(
            action_dim=7,
            action_horizon=10,
            max_token_len=180,
    ...
    TrainConfig(
        name="pi05_libero_domain_randomization",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
